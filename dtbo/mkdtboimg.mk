...
DTBDIR := $(PRODUCT_OUT)/obj/KERNEL_OBJ/arch/arm64/boot/dts/vendor/mediatek
APPEND_CERTS := $(DEVICE_PATH)/dtbo/append_certs.py

TARGET_DTBO_NAME ?= mt6895
...
$(BOARD_PREBUILT_DTBOIMAGE):
	...
	@echo "Appending certificates to DTBO image..."
	...
	@echo "Certificates and appended to $(BOARD_PREBUILT_DTBOIMAGE)."
